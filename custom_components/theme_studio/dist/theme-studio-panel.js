 ...
 */
const ye = globalThis, Oe = ye.ShadowRoot && (ye.ShadyCSS === void 0 || ye.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Le = Symbol(), je = /* @__PURE__ */ new WeakMap();
let at = class {
  constructor(t, r, o) {
  ...
  get styleSheet() {
    ...
    if (Oe && t === void 0) {
      ...
      o && (t = je.get(r)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && je.set(r, t));
    }
    return t;
  }
  toString() {
...
const Vt = (e) => new at(typeof e == "string" ? e : e + "", void 0, Le), B = (e, ...t) => {
  const r = e.length === 1 ? e[0] : t.reduce((o, a, i) => o + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(a) + e[i + 1], e[0]);
  return new at(r, e, Le);
}, Wt = (e, t) => {
  if (Oe) e.adoptedStyleSheets = t.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Kt, defineProperty: Zt, getOwnPropertyDescriptor: Jt, getOwnPropertyNames: Yt, getOwnPropertySymbols: qt, getPrototypeOf: Xt } = Object, I = globalThis, We = I.trustedTypes, Qt = We ? We.emptyScript : "", er = I.reactiveElementPolyfillSupport, se = (e, t) => e, ke = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Qt : null;
      break;
  ...
  return r;
} }, Ge = (e, t) => !Kt(e, t), Ke = { attribute: !0, type: String, converter: ke, reflect: !1, useDefault: !1, hasChanged: Ge };
...
let X = class extends HTMLElement {
  ...
  static getPropertyDescriptor(t, r, o) {
    const { get: a, set: i } = Jt(this.prototype, t) ?? { get() {
      return this[r];
    }, set(n) {
      this[r] = n;
    } };
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(se("properties"))) {
      const r = this.properties, o = [...Yt(r), ...qt(r)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const a of o) r.unshift(Ve(a));
    } else t !== void 0 && r.push(Ve(t));
    return r;
  }
  static _$Eu(t, r) {
    const o = r.attribute;
  ...
  _$ET(t, r) {
    ...
    if (a !== void 0 && o.reflect === !0) {
      const i = (o.converter?.toAttribute !== void 0 ? o.converter : ke).toAttribute(r, o.type);
  ...
  _$AK(t, r) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const i = o.getPropertyOptions(a), n = typeof i.converter == "function" ? { fromAttribute: i.converter } : i.converter?.fromAttribute !== void 0 ? i.converter : ke;
      this._$Em = a;
  ...
  requestUpdate(t, r, o, a = !1, i) {
    if (t !== void 0) {
      ...
      if (a === !1 && (i = this[t]), o ?? (o = n.getPropertyOptions(t)), !((o.hasChanged ?? Ge)(i, r) || o.useDefault && o.reflect && i === this._$Ej?.get(t) && !this.hasAttribute(n._$Eu(t, o)))) return;
      this.C(t, r, o);
    }
...
X.elementStyles = [], X.shadowRootOptions = { mode: "open" }, X[se("elementProperties")] = /* @__PURE__ */ new Map(), X[se("finalized")] = /* @__PURE__ */ new Map(), er?.({ ReactiveElement: X }), (I.reactiveElementVersions ?? (I.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const le = globalThis, Ze = (e) => e, we = le.trustedTypes, Je = we ? we.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, it = "$lit$", G = `lit$${Math.random().toFixed(9).slice(2)}$`, nt = "?" + G, tr = `<${nt}>`, J = document, me = () => J.createComment(""), he = (e) => e === null || typeof e != "object" && typeof e != "function", Ie = Array.isArray, rr = (e) => Ie(e) || typeof e?.[Symbol.iterator] == "function", Te = `[ 	
\f\r]`, ae = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ye = /-->/g, qe = />/g, K = RegExp(`>|${Te}(?:([^\\s"'>=/]+)(${Te}*=${Te}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Xe = /'/g, Qe = /"/g, st = /^(?:script|style|textarea|title)$/i, or = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), l = or(1), ee = Symbol.for("lit-noChange"), x = Symbol.for("lit-nothing"), et = /* @__PURE__ */ new WeakMap(), Z = J.createTreeWalker(J, 129);
function lt(e, t) {
...
const ar = (e, t) => {
  ...
  let a, i = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", n = ae;
  for (let c = 0; c < r; c++) {
    const d = e[c];
    let p, m, h = -1, b = 0;
    for (; b < d.length && (n.lastIndex = b, m = n.exec(d), m !== null); ) b = n.lastIndex, n === ae ? m[1] === "!--" ? n = Ye : m[1] !== void 0 ? n = qe : m[2] !== void 0 ? (st.test(m[2]) && (a = RegExp("</" + m[2], "g")), n = K) : m[3] !== void 0 && (n = K) : n === K ? m[0] === ">" ? (n = a ?? ae, h = -1) : m[1] === void 0 ? h = -2 : (h = n.lastIndex - m[2].length, p = m[1], n = m[3] === void 0 ? K : m[3] === '"' ? Qe : Xe) : n === Qe || n === Xe ? n = K : n === Ye || n === qe ? n = ae : (n = K, a = void 0);
    const f = n === K && e[c + 1].startsWith("/>") ? " " : "";
    i += n === ae ? d + tr : h >= 0 ? (o.push(p), d.slice(0, h) + it + d.slice(h) + G + f) : d + G + (h === -2 ? c : f);
  }
  return [lt(e, i + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), o];
};
class be {
  constructor({ strings: t, _$litType$: r }, o) {
    ...
    this.parts = [];
    let i = 0, n = 0;
    const c = t.length - 1, d = this.parts, [p, m] = ar(t, r);
    if (this.el = be.createElement(p, o), Z.currentNode = this.el.content, r === 2 || r === 3) {
      const h = this.el.content.firstChild;
      h.replaceWith(...h.childNodes);
    }
    for (; (a = Z.nextNode()) !== null && d.length < c; ) {
      if (a.nodeType === 1) {
        if (a.hasAttributes()) for (const h of a.getAttributeNames()) if (h.endsWith(it)) {
          const b = m[n++], f = a.getAttribute(h).split(G), w = /([.?@])?(.*)/.exec(b);
          d.push({ type: 1, index: i, name: w[2], strings: f, ctor: w[1] === "." ? nr : w[1] === "?" ? sr : w[1] === "@" ? lr : ze }), a.removeAttribute(h);
        } else h.startsWith(G) && (d.push({ type: 6, index: i }), a.removeAttribute(h));
        if (st.test(a.tagName)) {
          const h = a.textContent.split(G), b = h.length - 1;
          if (b > 0) {
            a.textContent = we ? we.emptyScript : "";
            for (let f = 0; f < b; f++) a.append(h[f], me()), Z.nextNode(), d.push({ type: 2, index: ++i });
            a.append(h[b], me());
          }
        }
      } else if (a.nodeType === 8) if (a.data === nt) d.push({ type: 2, index: i });
      else {
        let h = -1;
        for (; (h = a.data.indexOf(G, h + 1)) !== -1; ) d.push({ type: 7, index: i }), h += G.length - 1;
      }
      i++;
    }
  }
...
function te(e, t, r = e, o) {
  if (t === ee) return t;
  let a = o !== void 0 ? r._$Co?.[o] : r._$Cl;
  const i = he(t) ? void 0 : t._$litDirective$;
  return a?.constructor !== i && (a?._$AO?.(!1), i === void 0 ? a = void 0 : (a = new i(e), a._$AT(e, r, o)), o !== void 0 ? (r._$Co ?? (r._$Co = []))[o] = a : r._$Cl = a), a !== void 0 && (t = te(e, a._$AS(e, t.values), a, o)), t;
}
class ir {
  constructor(t, r) {
  ...
  u(t) {
    const { el: { content: r }, parts: o } = this._$AD, a = (t?.creationScope ?? J).importNode(r, !0);
    Z.currentNode = a;
    let i = Z.nextNode(), n = 0, c = 0, d = o[0];
    for (; d !== void 0; ) {
      if (n === d.index) {
        let p;
        d.type === 2 ? p = new ge(i, i.nextSibling, this, t) : d.type === 1 ? p = new d.ctor(i, d.name, d.strings, this, t) : d.type === 6 && (p = new dr(i, this, t)), this._$AV.push(p), d = o[++c];
      }
      n !== d?.index && (i = Z.nextNode(), n++);
    }
    return Z.currentNode = J, a;
  }
  p(t) {
    let r = 0;
...
class ge {
  ...
  constructor(t, r, o, a) {
    this.type = 2, this._$AH = x, this._$AN = void 0, this._$AA = t, this._$AB = r, this._$AM = o, this.options = a, this._$Cv = a?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, r = this) {
    t = te(this, t, r), he(t) ? t === x || t == null || t === "" ? (this._$AH !== x && this._$AR(), this._$AH = x) : t !== this._$AH && t !== ee && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : rr(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== x && he(this._$AH) ? this._$AA.nextSibling.data = t : this.T(J.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: r, _$litType$: o } = t, a = typeof o == "number" ? this._$AC(t) : (o.el === void 0 && (o.el = be.createElement(lt(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === a) this._$AH.p(r);
    else {
      const i = new ir(a, this), n = i.u(this.options);
      i.p(r), this.T(n), this._$AH = i;
    }
  }
  _$AC(t) {
    let r = et.get(t.strings);
    return r === void 0 && et.set(t.strings, r = new be(t)), r;
  }
  k(t) {
    Ie(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let o, a = 0;
    for (const i of t) a === r.length ? r.push(o = new ge(this.O(me()), this.O(me()), this, this.options)) : o = r[a], o._$AI(i), a++;
...
class ze {
  ...
  constructor(t, r, o, a, i) {
    this.type = 1, this._$AH = x, this._$AN = void 0, this.element = t, this.name = r, this._$AM = a, this.options = i, o.length > 2 || o[0] !== "" || o[1] !== "" ? (this._$AH = Array(o.length - 1).fill(new String()), this.strings = o) : this._$AH = x;
  }
  _$AI(t, r = this, o, a) {
    const i = this.strings;
    let n = !1;
    if (i === void 0) t = te(this, t, r, 0), n = !he(t) || t !== this._$AH && t !== ee, n && (this._$AH = t);
    else {
      const c = t;
      let d, p;
      for (t = i[0], d = 0; d < i.length - 1; d++) p = te(this, c[o + d], r, d), p === ee && (p = this._$AH[d]), n || (n = !he(p) || p !== this._$AH[d]), p === x ? t = x : t !== x && (t += (p ?? "") + i[d + 1]), this._$AH[d] = p;
    }
    n && !a && this.j(t);
  }
  j(t) {
...
class lr extends ze {
  ...
  _$AI(t, r = this) {
    if ((t = te(this, t, r, 0) ?? x) === ee) return;
    const o = this._$AH, a = t === x && o !== x || t.capture !== o.capture || t.once !== o.once || t.passive !== o.passive, i = t !== x && (o === x || a);
...
const cr = le.litHtmlPolyfillSupport;
cr?.(be, ge), (le.litHtmlVersions ?? (le.litHtmlVersions = [])).push("3.3.3");
const pr = (e, t, r) => {
  const o = r?.renderBefore ?? t;
  let a = o._$litPart$;
  if (a === void 0) {
    const i = r?.renderBefore ?? null;
    o._$litPart$ = a = new ge(t.insertBefore(me(), i), i, void 0, r ?? {});
  }
  return a._$AI(e), a;
};
/**
...
class k extends X {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = pr(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
const ur = de.litElementPolyfillSupport;
ur?.({ LitElement: k });
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const mr = { attribute: !0, type: String, converter: ke, reflect: !1, hasChanged: Ge }, hr = (e = mr, t, r) => {
...
function g(e) {
  return (t, r) => typeof r == "object" ? hr(e, t, r) : ((o, a, i) => {
...
const dt = "bubble-card", ct = "Bubble Card", pt = "0.1.0", ut = ">=2.0.0", mt = {
  method: "hacs-repo",
  value: "Clooos/Bubble-Card"
}, ht = "CSS-Variablen für Bubble Card (Clooos/Bubble-Card). 100+ Variablen über Global, Pop-Up, Button, Climate, Media-Player, Select, Slider und weitere Card-Types. Plugin wird nur geladen wenn HACS Clooos/Bubble-Card als installiert meldet.", gr = {
  id: dt,
  name: ct,
  version: pt,
  version_supported: ut,
  detect: mt,
  description: ht
  ...
  version: pt,
  version_supported: ut
}, Symbol.toStringTag, { value: "Module" })), bt = "ha-core", gt = "Home Assistant Core", ft = "0.1.0", _t = ">=2024.1.0", yt = {
  method: "always"
}, vt = "Grundlegende CSS-Variablen des HA-Frontends. Immer aktiv, keine Erkennung nötig.", _r = {
  id: bt,
  name: gt,
  version: ft,
  version_supported: _t,
  detect: yt,
  description: vt
  ...
  version: ft,
  version_supported: _t
}, Symbol.toStringTag, { value: "Module" })), xt = "mushroom", kt = "Mushroom", wt = "0.1.0", St = ">=3.0.0", Ct = {
  method: "hacs-repo",
  value: "piitaya/lovelace-mushroom"
}, $t = "CSS-Variablen für Mushroom Cards (piitaya/lovelace-mushroom). Typografie (Title/Subtitle/Card-Primary/Card-Secondary), Icons, Chips, Controls, Material-RGB-Palette und State-spezifische RGB-Farben für Climate/Cover/Lock/Person/etc. Plugin wird nur geladen wenn HACS piitaya/lovelace-mushroom als installiert meldet.", vr = {
  id: xt,
  name: kt,
  version: wt,
  version_supported: St,
  detect: Ct,
  description: $t
  ...
  version: wt,
  version_supported: St
}, Symbol.toStringTag, { value: "Module" })), Bt = "bubble-card", Mt = [
  {
    id: "global",
    label: "Global",
    label_en: "Global",
  ...
  id: Bt,
  variables: At
}, Symbol.toStringTag, { value: "Module" })), zt = "ha-core", Tt = [
  {
    id: "branding",
    label: "Marke",
    label_en: "Branding",
  ...
  id: zt,
  variables: Dt
}, Symbol.toStringTag, { value: "Module" })), Pt = "mushroom", Et = [
  {
    id: "card-primary",
  ...
  "picker.compare_snapshot_tooltip": "Update-Änderungen zeigen: Upstream-Snapshot (bei Fork) ↔ aktuelles Upstream — nur was sich seither geändert hat",
...
Eine Sicherung wird unter themes/.backups/ angelegt — der Schritt ist reversibel.`,
  ...
  "compare.snapshot_banner": "Update-Änderungen: links der Upstream-Stand bei Fork-Erstellung, rechts das aktuelle Upstream. Die Unterschiede sind genau das, was ein HACS-Update seither geändert/hinzugefügt hat.",
...
Deine Änderungen werden stattdessen in ein eigenes Theme abgeleitet. Name des neuen Themes:`,
  ...
  "editor.set_dark_default": "Als Dark-Default",
  "editor.set_dark_default_tooltip": "Dieses Theme als globales Dark-Mode-Standard-Theme setzen (frontend.set_theme mode: dark)",
  "editor.is_dark_default": "Dark-Standard",
  "editor.is_dark_default_tooltip": "Dieses Theme ist bereits das globale Dark-Mode-Standard-Theme",
  ...
  "picker.compare_snapshot_tooltip": "Show update changes: upstream snapshot (at fork time) ↔ current upstream — only what changed since",
  "picker.snapshot_label": "{theme} — snapshot at fork",
...
A backup is written to themes/.backups/ — this is reversible.`,
  ...
  "compare.snapshot_banner": "Update changes: left is the upstream as of fork creation, right is the current upstream. The differences are exactly what a HACS update has changed/added since.",
  "compare.col_variable": "Variable",
...
Your changes are derived into your own theme instead. Name of the new theme:`,
  ...
  "editor.set_dark_default_tooltip": "Set this theme as the global dark-mode default theme (frontend.set_theme mode: dark)",
  "editor.is_dark_default": "Dark default",
  "editor.is_dark_default_tooltip": "This theme is already the global dark-mode default theme",
...
function s(e, t, r) {
  const o = Q[ce][e] ?? Q.en[e] ?? Q.de[e] ?? t ?? e;
  return r ? o.replace(
    /\{(\w+)\}/g,
    (a, i) => i in r ? String(r[i]) : `{${i}}`
  ) : o;
}
const Fr = /-(radius|size|width|height|padding|margin|gap)$/, Rr = /-(color|bg|background)$/, Or = /-(image|background-image)$/, Lr = [
  /^#[0-9a-f]{3,8}$/i,
  // #rgb, #rrggbb, #rrggbbaa
  /^(rgba?|hsla?|hwb|lab|lch|oklab|oklch|color)\s*\(/i,
  /^(transparent|currentColor|inherit)$/i
], Gr = /^var\(\s*--[A-Za-z0-9_-]*-(color|bg|background)\b/i, Ir = /^-?\d*\.?\d+(px|rem|em|vh|vw|vmin|vmax|%)$/i, Ur = /^var\(\s*--[A-Za-z0-9_-]*-(radius|size|width|height|padding|margin|gap)\b/i;
function Nr(e) {
  const t = e.trim();
  if (t) {
    if (/url\s*\(/i.test(t) || /gradient\s*\(/i.test(t)) return "background";
    if (Lr.some((r) => r.test(t)) || Gr.test(t)) return "color";
    if (Ir.test(t) || Ur.test(t)) return "length";
  }
}
function jr(e, t) {
  if (/-family$/.test(e)) return "font-family";
  if (/-shadow$/.test(e)) return "shadow";
  if (Or.test(e)) return "background";
  if (Fr.test(e)) return "length";
  if (Rr.test(e)) return "color";
  if (t !== void 0) {
    const r = Nr(t);
    if (r) return r;
  }
...
function Kr(e, t) {
  const o = Vr.find(({ re: i }) => i.test(e))?.label ?? "Quelle unbekannt", a = Wr[t];
  return `${o} · vermutlich ${a} (Heuristik).`;
}
const Zr = /* @__PURE__ */ Object.assign({
  "../plugins/bubble-card/plugin.json": fr,
  "../plugins/ha-core/plugin.json": yr,
  "../plugins/mushroom/plugin.json": xr
}), Jr = /* @__PURE__ */ Object.assign({
  "../plugins/bubble-card/schema.json": wr,
  "../plugins/ha-core/schema.json": Cr,
  "../plugins/mushroom/schema.json": Br
});
function Yr() {
  const e = [];
  for (const [t, r] of Object.entries(Zr)) {
    const o = t.replace(/\/plugin\.json$/, "/schema.json"), a = Jr[o];
    if (!a) {
      console.warn(
    ...
    e.push({ manifest: r.default, schema: a.default });
  }
  return e;
}
const pe = Object.freeze(Yr());
let Se = null;
const Re = /* @__PURE__ */ new Set();
function qr(e) {
  Se = e === null ? null : new Set(e);
  for (const t of Re)
    try {
      t();
    } catch {
...
function Xr(e) {
  return [...e].sort((t, r) => {
    const o = tt.indexOf(t.manifest.id), a = tt.indexOf(r.manifest.id);
    return o !== -1 && a !== -1 ? o - a : o !== -1 ? -1 : a !== -1 ? 1 : t.manifest.id.localeCompare(r.manifest.id);
  });
}
function ue() {
  const e = pe.filter((t) => {
    const r = t.manifest.detect;
    return r.method === "always" ? !0 : r.method === "hacs-repo" && r.value ? Se === null ? !0 : Se.has(r.value) : !0;
  });
  return Xr(e);
}
...
for (const e of pe)
  for (const t of e.schema.variables)
    Ce.has(t.name) || Ce.set(t.name, { pluginId: e.manifest.id, def: t });
function $e(e, t) {
  const r = Ce.get(e);
  if (r)
    return {
      ...r.def,
      description: Qr(r.def),
      source: "schema",
      plugin: r.pluginId
    };
  const o = jr(e, t);
...
function Qr(e) {
  return Ne() === "en" && e.description_en ? e.description_en : e.description;
}
function eo(e) {
  return Ne() === "en" && e.label_en ? e.label_en : e.label;
}
function rt() {
  const e = ue();
  return {
    plugins: pe.length,
    pluginIds: pe.map((t) => t.manifest.id),
    activePluginIds: e.map((t) => t.manifest.id),
    indexedVariables: Ce.size,
    categories: pe.reduce(
      (t, r) => t + r.schema.categories.length,
      0
    ),
    hacsFilterApplied: Se !== null
  };
}
class V {
  constructor(t) {
    this._host = t, t.addController(this);
  }
  hostConnected() {
    this._unsub = Pr(() => this._host.requestUpdate());
  }
  hostDisconnected() {
    this._unsub?.(), this._unsub = void 0;
  }
}
var to = Object.defineProperty, ro = Object.getOwnPropertyDescriptor, F = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? ro(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && to(t, r, a), a;
};
let z = class extends k {
  constructor() {
    super(...arguments), this._open = !1, this._mode = "confirm", this._message = "", this._value = "", this._confirmLabel = "", this._cancelLabel = "", this._danger = !1, this._pending = null;
  }
  confirm(e) {
    return new Promise((t) => {
      this._mode = "confirm", this._message = e.message, this._confirmLabel = e.confirmLabel ?? s("common.ok"), this._cancelLabel = e.cancelLabel ?? s("common.cancel"), this._danger = !!e.danger, this._pending = { mode: "confirm", resolve: t }, this._open = !0, this.updateComplete.then(() => this._focusDefault());
    });
  }
  prompt(e) {
    return new Promise((t) => {
      this._mode = "prompt", this._message = e.message, this._value = e.defaultValue ?? "", this._confirmLabel = e.confirmLabel ?? s("common.ok"), this._cancelLabel = e.cancelLabel ?? s("common.cancel"), this._danger = !1, this._pending = { mode: "prompt", resolve: t }, this._open = !0, this.updateComplete.then(() => this._focusDefault());
    });
  }
  _focusDefault() {
    this._mode === "prompt" && this._input ? (this._input.focus(), this._input.select()) : this._confirmBtn?.focus();
  }
  _settle(e) {
    this._open = !1;
    const t = this._pending;
    this._pending = null, t && t.resolve(e);
  }
  _onConfirm() {
    this._settle(this._mode === "prompt" ? this._value : !0);
  }
  _onCancel() {
    this._settle(this._mode === "prompt" ? null : !1);
  }
  _onKeydown(e) {
    e.key === "Escape" ? (e.preventDefault(), this._onCancel()) : e.key === "Enter" && this._mode === "prompt" && (e.preventDefault(), this._onConfirm());
  }
  render() {
    return this._open ? l`
      <div
...
F([
  u()
], z.prototype, "_message", 2);
F([
  u()
], z.prototype, "_value", 2);
F([
  u()
], z.prototype, "_confirmLabel", 2);
F([
  u()
], z.prototype, "_cancelLabel", 2);
F([
  u()
], z.prototype, "_danger", 2);
F([
  Ue("input")
], z.prototype, "_input", 2);
F([
  Ue(".confirm-btn")
], z.prototype, "_confirmBtn", 2);
z = F([
  M("ts-modal")
], z);
let fe = null;
function Lt() {
  return fe || (fe = document.createElement("ts-modal"), document.body.appendChild(fe)), fe;
}
function U(e) {
  return Lt().confirm(e);
}
...
var ao = Object.defineProperty, io = Object.getOwnPropertyDescriptor, W = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? io(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && ao(t, r, a), a;
};
let H = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this._loading = !0, this._themes = [], this._errors = [], this._loadError = null, this._actionError = null, this._deleting = null;
  }
  connectedCallback() {
    ...
    return this._loading ? l`<div class="empty">${s("picker.loading")}</div>` : this._loadError ? l`<div class="error">
      ...
      (e) => l`
        ...
        n: e.variable_count
                    ...
                    ${e.is_fork && e.has_snapshot && this._upstreamFor(e) ? l`<button
                          class="compare-btn"
                          title=${s("picker.compare_snapshot_tooltip")}
                          @click=${() => this._compareSnapshot(e)}
                        >
                          Δ
                        </button>` : ""}
   ...
   */
  async _deleteFork(e) {
    if (!(this._deleting !== null || !await U({
      message: s("picker.delete_confirm", void 0, { theme: e.theme_name }),
    ...
    t && this.dispatchEvent(
      new CustomEvent("compare-snapshot", {
        detail: {
          snapshot: {
            file: e.file,
            label: s("picker.snapshot_label", void 0, {
              theme: t.theme_name
            })
          },
          upstream: {
...
var no = Object.defineProperty, so = Object.getOwnPropertyDescriptor, Gt = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? so(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
...
var lo = Object.defineProperty, co = Object.getOwnPropertyDescriptor, re = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? co(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && lo(t, r, a), a;
};
...
var po = Object.defineProperty, uo = Object.getOwnPropertyDescriptor, It = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? uo(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
...
var mo = Object.defineProperty, ho = Object.getOwnPropertyDescriptor, O = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? ho(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
...
function ie(e) {
  ...
  const o = r[1].trim(), a = (t.slice(0, r.index) + t.slice(r.index + r[0].length)).trim().replace(/\s+/g, " ");
  return { url: o, modifiers: a };
}
function _e(e, t) {
  const r = e.trim(), o = t.trim();
  if (!r && !o) return "none";
  if (!o) return r;
  const a = `url('${o}')`;
  return r ? `${r} ${a}` : a;
...
let T = class extends k {
  constructor() {
    super(...arguments), this.value = "", this._locale = new V(this), this._browsing = !1, this._imagesLoaded = !1, this._loadingImages = !1, this._images = [], this._imagesTruncated = !1, this._imagesError = null;
  }
  render() {
    if (go(this.value))
      return this._renderVarRef();
    const e = ie(this.value), t = !!e.url, r = t ? `background-image: url('${e.url.replace(/'/g, "\\'")}');` : "";
    return l`
      ...
      (o) => l`
            <button
              class="preset-btn"
              title=${s(o.titleKey)}
              @click=${() => this._applyPreset(o.modifiers)}
            >
              ${o.label}
            </button>
          `
  ...
  _onUrlChange(e) {
    const t = e.target.value, r = bo(t), { modifiers: o } = ie(this.value);
    this._emit(_e(o, r));
  }
  _onModsChange(e) {
    const t = e.target.value, { url: r } = ie(this.value);
    this._emit(_e(t, r));
  }
  _applyPreset(e) {
    const { url: t } = ie(this.value);
    this._emit(_e(e, t));
  }
  _clear() {
    this._emit("none");
  ...
  _pickImage(e) {
    const { modifiers: t } = ie(this.value), r = t || ot[0].modifiers;
    this._emit(_e(r, e)), this._browsing = !1;
  }
  _renderVarRef() {
    return l`
...
var fo = Object.defineProperty, _o = Object.getOwnPropertyDescriptor, oe = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? _o(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && fo(t, r, a), a;
};
let j = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this.src = "/lovelace/0", this.overrides = /* @__PURE__ */ new Map(), this._loaded = !1, this._loadError = null, this._appliedToFrame = /* @__PURE__ */ new Set();
  }
  render() {
    return l`
      <div class="toolbar">
...
var yo = Object.defineProperty, vo = Object.getOwnPropertyDescriptor, y = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? vo(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
...
const ve = {
  ...
  icon: "mdi:dots-horizontal"
}, E = "in-theme", S = "default";
function De(e) {
  return e === S ? s("editor.mode_default") : e.charAt(0).toUpperCase() + e.slice(1);
}
function xo(e) {
  return e === ve ? s("editor.cat_unknown") : e === xe ? s("editor.cat_other") : eo(e);
}
let _ = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this.file = "", this.themeName = "", this.hacsManaged = !1, this._loading = !0, this._error = null, this._rows = [], this._skippedKeys = [], this._saveStatus = { state: "idle" }, this._activeTab = E, this._activeMode = S, this._modes = [S], this._showPreview = !1, this._previewSrc = "/lovelace/0", this._settingDefault = !1, this._defaultJustSet = !1, this._darkDefaultJustSet = !1, this._defaultError = null, this._appliedVars = /* @__PURE__ */ new Set(), this._originalFullTheme = {}, this._onBeforeUnload = (e) => {
      this._dirtyCount() !== 0 && (e.preventDefault(), e.returnValue = "");
    };
  }
  connectedCallback() {
    super.connectedCallback(), this._unsubRegistry = Ot(() => this.requestUpdate()), window.addEventListener("beforeunload", this._onBeforeUnload), this._load();
  }
  disconnectedCallback() {
  ...
  updated(e) {
    ...
    (t || r) && (this._revertAll(), this._rows = [], this._activeTab = E, this._activeMode = S, this._modes = [S], this._defaultJustSet = !1, this._darkDefaultJustSet = !1, this._defaultError = null, this._load());
  }
  async _load() {
  ...
  _buildRows(e) {
    ...
    for (const [a, i] of Object.entries(e)) {
        ...
        for (const [m, h] of Object.entries(
          ...
          if (!(typeof h != "object" || h === null)) {
            ...
            for (const [b, f] of Object.entries(
              ...
              const w = String(f), q = b.startsWith("--") ? b : `--${b}`, Nt = q.slice(2), jt = $e(q, w);
              t.push({
                varName: q,
                yamlKey: Nt,
                meta: jt,
      ...
      const n = String(i), c = a.startsWith("--") ? a : `--${a}`, d = c.slice(2), p = $e(c, n);
      t.push({
        varName: c,
        yamlKey: d,
        meta: p,
    ...
    this._skippedKeys = r, this._rows = t, this._modes = o;
  }
  /**
  ...
  _ensurePluginRows(e, t) {
    ...
    a.length > 0 && (this._rows = [...this._rows, ...a]);
  }
  // ─── Save-Flow ──────────────────────────────────────────────────────
  async _save() {
    ...
    ).length, o = this._removingCount(), a = [];
    r > 0 && a.push(
      s(
      ...
      s(
        o === 1 ? "editor.save_part_remove_one" : "editor.save_part_remove_many",
        void 0,
        { n: o }
      )
    );
    const i = a.join(" + "), n = s("editor.save_confirm", void 0, {
      what: i,
      file: this.file,
      theme: this.themeName
    });
    if (!await U({ message: n })) return;
  ...
  _buildSaveMerge() {
    ...
    for (const [a, i] of Object.entries(this._originalFullTheme)) {
      if (a === "modes") continue;
      if (typeof i == "object" && i !== null) {
        e[a] = i;
        continue;
      }
      const n = a.startsWith("--") ? a.slice(2) : a, c = this._rows.find(
      ...
      if (c) {
        ...
        e[a] = c.current, r.add(c.varName);
      } else
        e[a] = i;
    }
    for (const a of this._rows)
      a.mode === S && (a.inTheme || a.markedForRemoval || a.current !== a.original && a.current !== "" && (r.has(a.varName) || (e[a.yamlKey] = a.current)));
    const o = this._modes.filter((a) => a !== S);
    if (o.length > 0 || Object.keys(t).length > 0) {
      ...
      for (const n of i) {
        ...
        for (const [m, h] of Object.entries(c)) {
          ...
          const b = m.startsWith("--") ? m.slice(2) : m, f = this._rows.find(
            (w) => w.mode === n && w.inTheme && w.yamlKey === b
          );
          if (f) {
        ...
        Object.keys(d).length > 0 && (a[n] = d);
      }
      Object.keys(a).length > 0 && (e.modes = a);
    }
    return e;
  }
  ...
  _groupByCategory(e) {
    ...
    for (const n of e) {
      let c;
      n.meta.source === "heuristic" ? c = ve.id : n.meta.category && t.has(n.meta.category) ? c = n.meta.category : c = xe.id;
      const d = r.get(c) ?? [];
      d.push(n), r.set(c, d);
    }
    const o = [];
    for (const [n, c] of t) {
      const d = r.get(n);
      d && d.length > 0 && o.push({ ...c, rows: d });
    }
    const a = r.get(ve.id);
    a && a.length > 0 && o.push({ ...ve, rows: a });
    const i = r.get(xe.id);
    return i && i.length > 0 && o.push({ ...xe, rows: i }), o;
  }
  ...
  async _resetAll() {
    ...
    e !== 0 && await U({
      message: s("editor.reset_confirm", void 0, { n: e }),
      danger: !0
    }) && (this._revertAll(), this._rows = this._rows.map((t) => ({
      ...t,
      current: t.original,
      markedForRemoval: !1
    })));
  ...
  async _onBack() {
    const e = this._dirtyCount();
    e > 0 && !await U({
      message: s("editor.back_confirm", void 0, { n: e }),
      danger: !0
  ...
  // ─── Tab/Mode-Handling ──────────────────────────────────────────────
  _onTabSelect(e) {
    e !== this._activeTab && (e !== E && this._ensurePluginRows(e, this._activeMode), this._activeTab = e);
  }
  _onModeSelect(e) {
    e !== this._activeMode && (this._activeTab !== E && this._ensurePluginRows(this._activeTab, e), this._activeMode = e);
  }
  _visibleRows() {
    const e = this._rows.filter((t) => t.mode === this._activeMode);
    return this._activeTab === E ? e.filter((t) => t.inTheme) : e.filter((t) => t.meta.plugin === this._activeTab);
  }
  ...
  _isDarkDefault() {
    return this._darkDefaultJustSet ? !0 : !!this.themeName && this.hass?.themes?.default_dark_theme === this.themeName;
  }
  /**
  ...
  async _setDefault(e) {
    const t = e === "dark";
    if (!((t ? this._isDarkDefault() : this._isDefault()) || this._settingDefault || !this.themeName)) {
      this._settingDefault = !0, this._defaultError = null;
      try {
        const o = { name: this.themeName };
        t && (o.mode = "dark"), await this.hass.connection.sendMessagePromise({
          type: "call_service",
          domain: "frontend",
          service: "set_theme",
          service_data: o
        }), t ? this._darkDefaultJustSet = !0 : this._defaultJustSet = !0;
      } catch (o) {
        this._defaultError = o instanceof Error ? o.message : String(o);
      } finally {
  ...
  _renderDefaultBtn(e) {
    ...
    const t = e === "dark", r = t ? this._isDarkDefault() : this._isDefault(), o = t ? {
    ...
    return l`
      <button
        class="default-btn ${r ? "is-default" : ""}"
        ?disabled=${r || this._settingDefault}
        @click=${() => this._setDefault(e)}
        title=${s(r ? o.isTip : o.setTip)}
      >
        ${t ? "🌙" : r ? "★" : "☆"}
        ${this._settingDefault ? s("editor.setting_default") : s(r ? o.is : o.set)}
      </button>
    `;
  }
  _renderDefaultError() {
  ...
  _renderTabs() {
    ...
    const e = this._rows.filter(
      ...
      { id: E, label: s("editor.tab_in_theme"), count: e }
    ];
    for (const r of ue())
      t.push({
        id: r.manifest.id,
  ...
  _renderDirtyBadge() {
    ...
    ).length, r = this._removingCount(), o = [];
    t > 0 && o.push(s("editor.dirty_adding", void 0, { n: t })), r > 0 && o.push(s("editor.dirty_removing", void 0, { n: r }));
    const a = o.length > 0 ? ` (${o.join(", ")})` : "", i = s(
      e === 1 ? "editor.dirty_count_one" : "editor.dirty_count_many",
      void 0,
      { n: e }
    );
    return l`<span class="dirty-badge">${i}${a}</span>`;
  }
  _renderBody() {
    if (this._loading)
    ...
    if (e.length === 0) {
      const r = this._activeTab === E ? this._activeMode === S ? s("editor.empty_default") : s("editor.empty_mode", void 0, {
        mode: De(this._activeMode)
      }) : s("editor.empty_plugin");
      return l`<div class="empty">${r}</div>`;
    }
    const t = this._groupByCategory(e);
    return l`
      ${this._activeTab === E && this._activeMode === S && this._skippedKeys.length > 0 ? l`<div class="notice">
            ${s("editor.notice_skipped_prefix")}
            ${this._skippedKeys.map(
      (r, o) => l`${o > 0 ? ", " : ""}<code>${r}</code>`
    )}${s("editor.notice_skipped_suffix")}
          </div>` : ""}
      ${this._activeMode !== S ? l`<div class="notice">
            <strong>${De(this._activeMode)}-Mode:</strong>
            ${s("editor.notice_mode_prefix")}
            <code>modes.${this._activeMode}</code>
            ${s("editor.notice_mode_suffix")}
          </div>` : ""}
      ${this._activeTab !== E ? l`<div class="notice">
  ...
  _renderRow(e) {
    const t = e.current !== e.original, r = e.markedForRemoval === !0, o = t || r, a = !e.inTheme && !t && !r, i = !e.inTheme && t && e.current !== "" && !r, n = ["row"];
    return t && !r && n.push("dirty"), r && n.push("removed"), l`
      <div class=${n.join(" ")}>
        <div class="meta-cell">
          <code class="var-name">
            ${o ? l`<span class="dirty-dot">●</span>` : ""}
            ${e.varName}
            ${e.meta.source === "heuristic" ? l`<span class="row-tag heuristic">${e.meta.type}</span>` : ""}
            ${a ? l`<span class="row-tag default"
...
y([
  u()
], _.prototype, "_darkDefaultJustSet", 2);
y([
  u()
...
var ko = Object.defineProperty, wo = Object.getOwnPropertyDescriptor, Y = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? wo(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && ko(t, r, a), a;
};
let R = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this._loading = !0, this._modules = [], this._errors = [], this._rootExists = !0, this._loadError = null;
  }
  connectedCallback() {
    super.connectedCallback(), this._load();
  }
...
var So = Object.defineProperty, Co = Object.getOwnPropertyDescriptor, L = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Co(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && So(t, r, a), a;
};
function $o(e) {
  ...
  for (; (o = r.exec(e)) !== null; ) {
    ...
    const c = t.get(a);
    c ? (c.count++, !c.fallback && n && (c.fallback = n)) : t.set(a, { name: a, fallback: n, count: 1 });
  }
  return [...t.values()].sort((a, i) => a.name.localeCompare(i.name));
}
let D = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this.file = "", this.moduleId = "", this._loading = !0, this._error = null, this._content = {}, this._original = {}, this._saveStatus = { state: "idle" }, this._onBeforeUnload = (e) => {
  ...
  async _onBack() {
    this._isDirty() && !await U({
      message: s("module_editor.back_confirm"),
      danger: !0
    }) || this.dispatchEvent(
      new CustomEvent("back-to-picker", { bubbles: !0, composed: !0 })
    );
  ...
  async _save() {
    if (!(!this._isDirty() || this._saveStatus.state === "saving") && await U({
      message: s("module_editor.save_confirm", void 0, {
  ...
  async _resetAll() {
    this._isDirty() && await U({
      message: s("module_editor.reset_confirm"),
      danger: !0
  ...
  render() {
    ...
    const e = this._content.name || this.moduleId, t = this._content.description || "", r = this._content.version || "", o = Array.isArray(this._content.supported) ? this._content.supported : [], a = this._content.is_global === !0, i = this._content.code || "", n = /* @__PURE__ */ new Set([
      "name",
      "description",
      "version",
      "supported",
  ...
  _renderVarItem(e) {
    const t = $e(e.name, e.fallback), r = t.source === "schema", o = t.type === "color" && e.fallback ? l`<span class="var-swatch" style=${`background:${e.fallback}`}></span>` : "";
    return l`
      <div class="var-item">
        <div class="var-header">
          <span class="var-name">${o}${e.name}</span>
  ...
  _onSupportedInput(e) {
    const r = e.target.value.split(",").map((o) => o.trim()).filter((o) => o.length > 0);
...
L([
  u()
], D.prototype, "_content", 2);
L([
  u()
], D.prototype, "_original", 2);
L([
  u()
], D.prototype, "_saveStatus", 2);
D = L([
  M("ts-module-editor")
], D);
var Bo = Object.defineProperty, Mo = Object.getOwnPropertyDescriptor, A = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Mo(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && Bo(t, r, a), a;
};
function Ao(e) {
  return !!e && "snapshot_file" in e;
}
const v = "default", zo = {
  selection: null,
  full: {},
...
let C = class extends k {
  constructor() {
    super(...arguments), this._locale = new V(this), this.presetA = null, this.presetB = null, this._themes = [], this._themesError = null, this._themesLoading = !0, this._sideA = this._freshSide(), this._sideB = this._freshSide(), this._diffOnly = !0, this._copyStatus = { state: "idle" }, this._activeMode = v, this._snapshotSide = null;
  }
  get _busyCopy() {
  ...
  async _loadThemes() {
    ...
    try {
      ...
      this._themes = e.themes, this.presetA || this.presetB ? (await this._applyPreset("A", this.presetA), await this._applyPreset("B", this.presetB)) : (this._themes.length >= 1 && !this._sideA.selection && await this._setSide("A", this._themes[0]), this._themes.length >= 2 && !this._sideB.selection && await this._setSide("B", this._themes[1]));
    } catch (e) {
  ...
  async _applyPreset(e, t) {
    if (t)
      if (Ao(t))
        await this._setSideSnapshot(e, t.snapshot_file, t.label);
      else {
        const r = this._findEntry(t);
        r && await this._setSide(e, r);
      }
  }
  /** Lädt einen Upstream-Snapshot (via get_snapshot) als Vergleichs-Seite. */
  async _setSideSnapshot(e, t, r) {
    this._writeSide(e, { ...this._freshSide(), loading: !0 });
    try {
      const o = await this.hass.connection.sendMessagePromise({
        type: "theme_studio/get_snapshot",
        file: t
      }), a = this._extractScalarsByMode(o.variables);
      this._writeSide(e, {
        selection: {
          file: t,
          theme_name: r,
          variable_count: Object.keys(o.variables).length
        },
        full: o.variables,
        scalarsByMode: a,
        modes: Object.keys(a),
  ...
  async _setSide(e, t) {
    const o = { ...e === "A" ? this._sideA : this._sideB, selection: t };
    if (this._writeSide(e, o), !t) {
      this._writeSide(e, this._freshSide());
      return;
    }
    this._writeSide(e, { ...o, loading: !0, error: null });
    try {
      const a = await this.hass.connection.sendMessagePromise({
        type: "theme_studio/get_theme",
        file: t.file,
        theme_name: t.theme_name
      }), i = this._extractScalarsByMode(a.variables);
      this._writeSide(e, {
        ...o,
        loading: !1,
        full: a.variables,
  ...
  _extractScalarsByMode(e) {
    ...
    for (const [r, o] of Object.entries(e)) {
      if (r === "modes" && o && typeof o == "object" && !Array.isArray(o)) {
      ...
      o != null && typeof o != "object" && (t[v][r] = String(o));
    }
    return t;
  }
  /** Anzahl unterschiedlicher Scalars in einem Mode (für Mode-Badges/Hinweis). */
  _diffCountForMode(e) {
    const t = this._sideA.scalarsByMode[e] ?? {}, r = this._sideB.scalarsByMode[e] ?? {}, o = /* @__PURE__ */ new Set([...Object.keys(t), ...Object.keys(r)]);
    let a = 0;
    for (const i of o) {
  ...
  _availableModes() {
    ...
    const t = [...e].filter((r) => r !== v).sort();
    return [v, ...t];
  }
  _modeLabel(e) {
    return e === v ? s("compare.mode_default") : e.charAt(0).toUpperCase() + e.slice(1);
  }
  _onSelect(e, t) {
    this._snapshotSide === e && (this._snapshotSide = null);
    const r = t.target.value;
    if (!r) {
      this._setSide(e, null);
      return;
    }
    const [o, a] = r.split("§§"), i = this._themes.find(
      (n) => n.file === o && n.theme_name === a
    );
    i && this._setSide(e, i);
  }
  render() {
    return this._themesLoading ? l`<div class="loading">${s("picker.loading")}</div>` : this._themesError ? l`<div class="error">
      ...
      ${this._snapshotSide ? l`<div class="snapshot-banner">
            📷 ${s("compare.snapshot_banner")}
          </div>` : ""}
  ...
  _renderModeSelector() {
    ...
    e.includes(this._activeMode) || (this._activeMode = v);
    const t = !!this._sideA.selection && !!this._sideB.selection;
    return l`
      <div class="mode-selector">
        <span class="label">${s("compare.mode_selector_label")}</span>
        ${e.map((r) => {
      const o = this._sideA.modes.includes(r), a = this._sideB.modes.includes(r), i = r !== v && (!o || !a), n = this._modeLabel(r), c = t ? this._diffCountForMode(r) : 0;
      return l`
            <button
        ...
        side: o ? "A" : "B"
            ...
            >
              ${n}${i ? l`<span class="badge-only">${o ? "A" : "B"}</span>` : ""}${c > 0 ? l`<span class="diff-badge" title=${s("compare.mode_diff_badge_title", void 0, { n: c })}>${c}</span>` : ""}
            </button>
          `;
    })}
      </div>
  ...
  _renderSelector(e, t) {
    if (e === this._snapshotSide)
      return l`<div class="snapshot-pill" title=${t?.theme_name ?? ""}>
        📷 ${t?.theme_name ?? ""}
      </div>`;
    const r = t ? `${t.file}§§${t.theme_name}` : "";
    return l`
      <select @change=${(o) => this._onSelect(e, o)}>
        <option value="">${s("compare.no_theme")}</option>
        ${this._themes.map(
      (o) => l`
            <option
              value="${o.file}§§${o.theme_name}"
              ?selected=${r === `${o.file}§§${o.theme_name}`}
            >
              ${o.theme_name} (${o.file})
            </option>
          `
  ...
  _renderBody() {
    ...
    const r = this._activeMode, o = e.scalarsByMode[r] ?? {}, a = t.scalarsByMode[r] ?? {}, i = r === v || e.modes.includes(r), n = r === v || t.modes.includes(r), c = this._modeLabel(r), d = Array.from(
      /* @__PURE__ */ new Set([...Object.keys(o), ...Object.keys(a)])
    ).sort(), p = d.map((b) => ({
      key: b,
      valA: o[b] ?? null,
      valB: a[b] ?? null
    })).filter((b) => !this._diffOnly || b.valA === null || b.valB === null ? !0 : b.valA !== b.valB), m = d.reduce((b, f) => {
      const w = o[f] ?? null, q = a[f] ?? null;
      return w === null || q === null ? b + 1 : b + (w !== q ? 1 : 0);
    }, 0), h = r === v ? "" : !i || !n ? l` <em>
              ·
    ...
    return l`
      ...
      countA: Object.keys(o).length,
      themeB: t.selection.theme_name,
      countB: Object.keys(a).length
    })}
        <strong
  ...
  _renderRow(e, t, r) {
    const o = e.startsWith("--") ? e : `--${e}`, a = $e(o, t ?? r ?? void 0), i = t !== null && r === null, n = r !== null && t === null, d = [
      "row",
      i ? "only-a" : "",
      n ? "only-b" : "",
      !i && !n && t !== r ? "diff" : ""
    ...
    return l`
      <tr class=${d}>
        <td class="var-cell">
          ${o}
          ${a.description ? l`<div class="description">${a.description}</div>` : ""}
        </td>
  ...
  async _copy(e, t, r, o) {
    const a = e === "A" ? this._sideA : this._sideB, i = t === "A" ? this._sideA : this._sideB;
    if (!a.selection || !i.selection) return;
    const n = this._activeMode, c = this._modeLabel(n), p = !(n === v) && !i.modes.includes(n), m = s("compare.copy_confirm", void 0, {
      key: r,
      value: o,
      from: a.selection.theme_name,
    ...
    const h = this._mergeValue(i.full, n, r, o);
    try {
   ...
   */
  _mergeValue(e, t, r, o) {
    const a = { ...e }, i = (m) => Object.keys(m).find((b) => (b.startsWith("--") ? b.slice(2) : b) === r) ?? r;
    if (t === v)
      return a[i(a)] = o, a;
    const n = a.modes, c = n && typeof n == "object" && !Array.isArray(n) ? { ...n } : {}, d = c[t], p = d && typeof d == "object" && !Array.isArray(d) ? { ...d } : {};
    return p[i(p)] = o, c[t] = p, a.modes = c, a;
  }
};
C.styles = B`
    :host {
...
A([
  u()
], C.prototype, "_snapshotSide", 2);
C = A([
  M("ts-compare-view")
], C);
var To = Object.defineProperty, Do = Object.getOwnPropertyDescriptor, Ut = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Do(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && To(t, r, a), a;
};
let Ae = class extends k {
  ...
  _onChange(e, t) {
    const r = e.target.tagName.toLowerCase(), o = (/* @__PURE__ */ new Date()).toLocaleTimeString();
    this._log = [{ tag: r, label: t, value: e.detail.value, at: o }, ...this._log].slice(
      0,
      30
    );
  }
...
var Po = Object.defineProperty, Eo = Object.getOwnPropertyDescriptor, P = (e, t, r, o) => {
  for (var a = o > 1 ? void 0 : o ? Eo(t, r) : t, i = e.length - 1, n; i >= 0; i--)
    (n = e[i]) && (a = (o ? n(t, r, a) : n(a)) || a);
  return o && a && Po(t, r, a), a;
};
const Pe = "themes", Ee = "modules", ne = "compare";
let $ = class extends k {
  constructor() {
    super(...arguments), this.narrow = !1, this._selectedTheme = null, this._selectedModule = null, this._topTab = Pe, this._comparePreset = null, this._demoMode = !1, this._hacsError = null, this._hacsErrorDismissed = !1, this._locale = new V(this), this._onHashChange = () => {
      this._demoMode = window.location.hash === "#demo";
    };
  }
  connectedCallback() {
    super.connectedCallback(), Rt(Er() ?? this.hass?.language), console.info("[theme-studio] registry (initial):", rt()), this._demoMode = window.location.hash === "#demo", window.addEventListener("hashchange", this._onHashChange), this._unsubRegistry = Ot(() => this.requestUpdate()), this._loadHacsRepos();
  }
  async _loadHacsRepos() {
    try {
      const e = await this.hass.connection.sendMessagePromise({ type: "theme_studio/list_hacs_repos" });
      e.found ? (qr(e.repos), console.info(
  ...
  _renderLocaleSelector() {
    ...
    return l`
      <select
        ...
        aria-label=${s("panel.language")}
        @change=${(r) => Hr(
      r.target.value
    )}
      >
        ${e.map(
      (r) => l`<option value=${r} ?selected=${r === t}>
            ${zr[r]}
          </option>`
    )}
      </select>
  ...
  _renderTopTabs() {
    ...
    return l`
      <div class="top-tabs">
        ...
        ${e ? l`
              <button
                class="top-tab ${this._topTab === Ee ? "active" : ""}"
                @click=${() => this._setTopTab(Ee)}
              >
                ${s("panel.tab_modules")}
              </button>
            ` : ""}
        <button
          class="top-tab ${this._topTab === ne ? "active" : ""}"
          @click=${() => this._setTopTab(ne)}
        >
          ${s("panel.tab_compare")}
        </button>
      </div>
  ...
  _renderPickerForTab() {
    return this._topTab === Ee ? l`
        <ts-module-picker
          .hass=${this.hass}
          @module-selected=${this._onModuleSelect}
        ></ts-module-picker>
      ` : this._topTab === ne ? l`<ts-compare-view
        .hass=${this.hass}
  ...
  _onCompareUpstream(e) {
    this._comparePreset = { a: e.detail.fork, b: e.detail.upstream }, this._topTab = ne;
  }
